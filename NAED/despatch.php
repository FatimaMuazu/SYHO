...
<body>
	...
	<div class="container">
		<h1> Despatch </h1>
		<form action="afterdespatch.php" method="post">
		<table align="center" width="100%" border="5" bgcolor="white">
		<tr align="center">
			<td colspan="8"><h5>Insert Books to despatch</h5></td>
		</tr>
		...
		<tr>
			<td><label for="recepient">Recepient:</label></td>
			<td><input type="text" id="recepient" name="recepient" required/></td>
		</tr>
			
		<tr>
			<td><label for="dateofdespatch">Date of Despatch:</label></td>
			<td><input type="date" id="dateofdespatch" name="dateofdespatch" required/></br></td>
		</tr>
		
		<tr>
			<td><button type="submit" name="submit" value="Despatch">Despatch</button></td>
